...
from ffdiffusion.utils.diffusion import batch_mul, get_score
...
def get_loss(
    ...
    **kwargs,
    ...
    sde = sdes.VP()
    from ffdiffusion.diffusion.fp import fp_vp_loss
    ...
    def loss(
        ...
        # TODO: this is not the best place for this loss. Move into SDE class
        score = None
